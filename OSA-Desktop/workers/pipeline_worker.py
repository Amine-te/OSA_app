...
class PipelineWorker(QThread):
    ...
    def __init__(self, rtsp_url: str, config: dict):
        super().__init__()
    ...
    def run(self):
        try:
            ...
            self._process_rtsp_stream(pipeline)
    ...
    def _process_rtsp_stream(self, pipeline):
        from workers.stream_manager import StreamManager

        stream_manager = StreamManager(self.rtsp_url, is_rtsp=True)
